...
export declare const SKU_SELECTOR_CSS_HANDLES: readonly ["errorMessage", "frameAround", "valueWrapper", "diagonalCross", "skuSelectorItem", "skuSelectorBadge", "skuSelectorItemImage", "skuSelectorInternalBox", "skuSelectorItemTextValue", "skuSelectorItemImageValue", "skuSelectorContainer"];
interface Props {
