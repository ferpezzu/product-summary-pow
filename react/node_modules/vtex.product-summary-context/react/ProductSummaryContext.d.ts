...
import { Product, SingleSKU, State } from './ProductSummaryTypes';
...
declare type Action = SetProductAction | SetHoverAction | SetLoadingAction | SetPriceLoadingAction | SetProductQuantity | SetProductQueryAction | SetInView;
...
declare function ProductSummaryProvider({ product, selectedItem, isLoading, isPriceLoading, listName, children, }: PropsWithChildren<ProviderProps>): JSX.Element;
