...
declare function ProductSummaryWrapper({ product, actionOnClick, href, priceBehavior, trackListName, listName, position, classes, children, }: PropsWithChildren<Props>): JSX.Element;
