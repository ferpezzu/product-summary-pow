...
declare function ProductImage({ showBadge, badgeText, displayMode, mainImageLabel, hoverImageLabel, hoverImage, showCollections, placeholder, width: widthProp, height: heightProp, aspectRatio: aspectRatioProp, maxHeight: maxHeightProp, classes, }: Props): JSX.Element;
